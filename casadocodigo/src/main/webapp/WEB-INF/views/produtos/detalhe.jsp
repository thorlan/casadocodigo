  ...
  <header id="layout-header">
	    ...
	    <ul id="variants" class="clearfix">
			...
			<c:forEach items="${produto.precos }" var="preco">
			  <li class="buy-option">
			    ...
			    <small class="compare-at-price"> 60.00</small>
			    <p> ${preco.valor }</p>
	...
	<div class="container">
	  <section class="summary">
	    <ul>
	      	<li><h3>E muito mais... <a href='/pages/sumario-java8'>Sumário</a>.</h3></li>
	    </ul>
	  </section>
	  ...
	  <section class="data product-detail">
	    ...
	    <p></p>
	    <p>Data de publicação: <fmt:formatDate value="${produto.dataLancamento.time}" type="date" pattern="dd/MM/yyyy" /></p>
